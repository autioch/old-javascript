function savesPanelClass() {

    this.saveTemplate = null;
    this.panel = $('#savesPanel');
    this.name = 'savesPanel';
    this.savedGames = null;

    this.clearPanel = function() {
        $('#panelBackground').show();
        this.savedGames = JSON.parse(localStorage.getItem('savedGames'));
        $('#savesPanelSaveDescription').html('Map ' + this.currentMap + ', ' + game.day + ' day(s), ' + game.hour + ' hour(s)');

        $('#savesPanelSlotList').children().remove();
        for (var sg in this.savedGames) {
            this.printSaveSlot(this.savedGames[sg]);
        }
        this.panel.show();
    };
    ...
    this.init = function() {
        ...
        $('#savesPanelCloseButton').on('click', function() {
            system.hidePanel('savesPanel');
        });
        ...
        $('#saveSave').on('click', function() {
            ...
            if (savesPanel.savedGames && savesPanel.savedGames[sn]) {
